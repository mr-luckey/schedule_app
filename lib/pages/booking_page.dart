...
//                 <strong>Reference:</strong> WEDDING-${controller.nameController.text.split(' ').map((n) => n[0]).join().toUpperCase()}-001<br>
...
//                         <tr><td>Customer Name:</td><td>${controller.nameController.text}</td></tr>
//                         <tr><td>Email:</td><td>${controller.emailController.text}</td></tr>
//                         <tr><td>Contact:</td><td>${controller.contactController.text}</td></tr>
//                         <tr><td>Event Address:</td><td>${controller.selectedCity.value}</td></tr>
//                     </table>
//                 </div>
//             </div>
//             <div class="column">
...
//                     <table class="info-table">
//                         <tr><td>Event Type:</td><td>${controller.selectedEventType.value}</td></tr>
//                         <tr><td>Date:</td><td>${formatDate(controller.selectedDate.value)}</td></tr>
//                         <tr><td>Time:</td><td>${formatTime(controller.startTime.value)} - ${formatTime(controller.endTime.value)}</td></tr>
//                         <tr><td>Guests:</td><td>${controller.guests.value} persons</td></tr>
//                         <tr><td>Package:</td><td>${controller.selectedPackage.value}</td></tr>
//                     </table>
//                 </div>
//             </div>
//         </div>
...
//         <div class="footer">
//             <p><strong>BOOKING CONFIRMED - PAYMENT DUE: 50% DEPOSIT BY ${formatDate(controller.selectedDate.value?.subtract(const Duration(days: 14)))}</strong></p>
...
// Copy the entire _generateReceiptHTML method content from ReceiptPopup here
// Make sure to remove the duplicate method from ReceiptPopup
// }
/* ---------------------------
