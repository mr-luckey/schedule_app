...
<body>
  ...
  void showBookingConfirmation() {
    ...
    if (confirmPressCount.value == 1) {
      // First press - show normal receipt
      ...
      //     );
      //   }
      // Get.to(PaymentPopup(eventName: , venue: venue, date: date, startTime: startTime, endTime: endTime, guests: guests, package: package, totalAmount: totalAmount, customerName: customerName, customerEmail: customerEmail, onConfirm: onConfirm, onCancel: onCancel))
      ...
      // Get.to(PaymentPopup(eventName: eve, venue: venue, date: date, startTime: startTime, endTime: endTime, guests: guests, package: package, totalAmount: totalAmount, customerName: customerName, customerEmail: customerEmail, onConfirm: onConfirm, onCancel: onCancel))      // Second or subsequent press - show red warning popup
      // Get.dialog(
      //   AlertDialog(
      //     backgroundColor: Colors.red[100],
      //     title: Text('Warning', style: TextStyle(color: Colors.red[900])),
      //     content: Text(
      //       'You have already confirmed this booking. Would you like to view the receipt again?',
  ...
  Future<void> completeBooking() async {
    try {
      ...
      confirmPressCount.value = 0; // Reset counter
      Get.back(); // Close popup
      Get.snackbar(
        'Success',
        'Booking confirmed successfully!',
