      ...
      return Container(
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<Discount>(
            isExpanded: true,
            value: editController.selectedDiscount.value,
            icon: const Padding(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        Icons.discount,
                        color: discount.title == "No Discount"
                            ? Colors.grey
                            : AppColors.primary,
                        size: 20,
                      ),
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            fontWeight: discount.title == "No Discount"
                                ? FontWeight.normal
                                : FontWeight.w500,
                          ),
                        ),
                      ),
                      if (discount.title != "No Discount")
                        Text(
            ...
            onChanged: (Discount? newValue) {
              editController.setSelectedDiscount(newValue);
              if (newValue!.title == "No Discount") {
                editController.isDiscountApplied.value = false;
              } else {
