...
//               vertical: 16,
//             ), // Inner padding
//             errorMaxLines: 2, // Prevent error text from overflowing
//           ),
//         ),
//       ],
//     );
                    ...
                    controller: TextEditingController.fromValue(
                      TextEditingValue(
                        ...
                        selection: TextSelection.collapsed(
                          offset: controller.guests.value.toString().length,
                        ),
                      ),
                    ),
                    onChanged: (value) {
                      if (value.isNotEmpty) {
                        ...
                        controller.setGuests(intValue.clamp(0, 10000));
                      } else {
                        controller.setGuests(0);
                      }
                    },
